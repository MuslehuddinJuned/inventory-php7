<template>
    <div class="container-fluid justify-content-center">
        ...
        <b-modal ref="dataEdit" id="dataEdit" size="lg" :title="$t('increment_file')" no-close-on-backdrop>            
        ...
        <b-modal class="b-0" ref="dataView" id="dataView" size="xl" :title="$t('increment_file')" no-close-on-backdrop>
            <div class="modal-body row m-0 p-0">
