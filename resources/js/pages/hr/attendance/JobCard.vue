            ...
            <div v-for="data in salarySheetByDepartment" :key="data.id">
                <div class="col-12 row m-0 p-0">
                    ...
                    <div class="col-6 row m-0 p-0 border-top border-right border-dark mb-1">
                        ...
                        <div class="col-4 text-right">{{(data.basic_monthly || 0).toFixed(2)}}</div>
                        <div class="col-8">House Rent 50% Basic (বাড়ী ভাড়া)</div>
                        <div class="col-4 text-right">{{(data.house_rent || 0).toFixed(2)}}</div>
                        <div class="col-8">Med.Allow (চিকিৎসা ভাতা)</div>
                        <div class="col-4 text-right">{{(data.medic_allowance || 0).toFixed(2)}}</div>
                        <div class="col-8">Total Salary (মোট বেতন)</div>
                        <div class="col-4 text-right border-top border-dark">{{(data.salary || 0).toFixed(2)}}</div>
                        ...
                        <div class="col-4 text-right">{{(data.ot_amount || 0).toFixed(2)}}</div>
                        ...
                        <div class="col-4 text-right">{{(data.worked_holiday_amount || 0).toFixed(2)}}</div>
                        <div class="col-8">No. Of Hours (মোট কর্মঘন্টা)</div>
                        <div class="col-4 text-right">{{(data.worked_holiday_hour || 0).toFixed(2)}}</div>
                        <div class="col-8">Fridays - Worked (সাপ্তাহিক ছুটি)</div>
                        <div class="col-4 text-right">{{(data.worked_friday_amount || 0).toFixed(2)}}</div>
                        <div class="col-8">No. Of Hours (মোট কর্মঘন্টা)</div>
                        <div class="col-4 text-right">{{(data.worked_friday_hour || 0).toFixed(2)}}</div>
                        <div class="col-8">Add'l Adjustment (অন্যান্য সম্বনয়)</div>
                        <div class="col-4 text-right">{{(data.total_allowance || 0).toFixed(2)}}</div>
                        <div class="col-8">Gross  Pay: (প্রাপ্য বেতন)</div>
                        <div class="col-4 text-right border_bottom border-top border-dark">{{(data.gross_pay || 0).toFixed(2)}}</div>
                    </div>
                    <div class="col-6 row m-0 p-0 border-top border-dark mb-1">
                        <div class="col-8">Gross  Pay: (প্রাপ্য বেতন)</div>
                        <div class="col-4 text-right">{{(data.gross_pay || 0).toFixed(2)}}</div>
                        ...
                        <div class="col-4 text-right">{{(data.absent_amount || 0).toFixed(2)}}</div>
                        <div class="col-8">No.of days (দিনের সংখ্যা)</div>
                        ...
                        <div class="col-4 text-right">{{(data.advance || 0).toFixed(2)}}</div>
                        <div class="col-8">Provident  Fund (ভবিষ্যত তহবিল)</div>
                        <div class="col-4 text-right">{{(data.pf || 0).toFixed(2)}}</div>
                        <div class="col-8">Penalty (জরিমানা)</div>
                        <div class="col-4 text-right">{{(0).toFixed(2)}}</div>
                        <div class="col-8">Ded'l Adjustment (কর্তনযোগ্য সম্বনয়)</div>
                        <div class="col-4 text-right">{{(data.deducted || 0).toFixed(2)}}</div>
                        ...
                        <div class="col-4 text-right">{{(data.not_for_join_amount || 0).toFixed(2)}}</div>
                        <div class="col-8">Lay off days  (সাময়িক ছুটি)</div>
                        <div class="col-4 text-right">{{(data.lay_off_days || 0).toFixed(2)}}</div>
                        <div class="col-8">Amount (টাকা)</div>
                        <div class="col-4 text-right">{{(data.lay_off_amount || 0).toFixed(2)}}</div>
                        <div class="col-8">Total Deduction (মোট বিয়োজন )</div>
                        <div class="col-4 text-right border-top border-bottom border-dark">{{(data.total_deduction || 0).toFixed(2)}}</div>
                        <div class="col-8">NET PAY (প্রাপ্ত বেতন)</div>
                        <div class="col-4 text-right border-bottom border-dark border-3">{{(data.net_pay || 0).toFixed(2)}}</div>
                    </div>
