       ...
       <div class="col-md-12" :class="noprint">
           <div class="card filterable">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <button v-if="checkRoles('ItemReceive_Insert')" @click="addDetails" class="mdb btn btn-outline-info" v-b-modal.dataEdit>{{ $t('InsertNew') }}</button>
                    </div> 
                </div>
        ...
        <b-modal ref="dataView" id="dataView" size="xl" :title="$t('ItemReceive')" no-close-on-backdrop>
            ...
            <template v-slot:modal-footer="">
                <div class="row m-0 p-0 col-md-12">
                    ...
                    <div class="col-md-5">
                        <button v-if="checkRoles('ItemReceive_Delete')" @click="destroy" class="mdb btn btn-outline-danger float-left">{{ $t('delete') }}</button>
                    </div>
                    <div class="col-md-7">
                        <button @click="archive" type="button" class="mdb btn btn-outline-mdb-color float-right">{{$t('Close')}}</button>
                        <button v-if="checkRoles('ItemReceive_Update')" @click="editDetails" class="mdb btn btn-outline-default float-right">{{ $t('edit') }}</button>
                    </div>
                </div>
            </template>
        </b-modal>
    ...
    computed: {
        ...
        taskDetailsfields() {
            ...
            if(this.store == 3){
                return [
                    ...
                    { key: 'receive_etd', label : this.$t('ETD'), class: 'text-center align-middle', thClass: 'border-top border-dark font-weight-bold'},
        ...
        taskDetailsfieldsView() {
            ...
            if(this.store == 3){
                ...
                return [
                    { key: 'index', label : '#', class: 'text-center align-middle', thClass: 'border-top border-dark font-weight-bold' },
                    { key: 'item_code', label : this.$t('material') + ' ' + this.$t('code'), class: 'text-center align-middle', thClass: 'border-top border-dark font-weight-bold'},
                    { key: 'item', label : this.$t('material') + ' ' + this.$t('name'), class: 'text-center align-middle', thClass: 'border-top border-dark font-weight-bold'},
