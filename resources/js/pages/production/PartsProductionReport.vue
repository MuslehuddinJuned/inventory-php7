    ...
    computed: {
        ...
        fields() {
            ...
            return [
                ...
                { key: 'item_code', label : this.$t('material_number'), class: 'text-center align-middle', sortable: true, thClass: 'text-nowrap border-top border-dark font-weight-bold' },
                { key: 'item', label : this.$t('material_name'), stickyColumn: true, class: 'bg-white text-center align-middle', sortable: true, thClass: 'text-nowrap border-top border-dark font-weight-bold'},
                { key: 'specification', label : this.$t('description'), class: 'text-center align-middle', tdClass: 'p-0', sortable: true, thClass: 'text-nowrap border-top border-dark font-weight-bold' },
