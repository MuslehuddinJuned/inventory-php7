...
class RecdetailsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        master_sheet, cann_per_sheet, remarks, accept, A.inventory_id, receive_etd, issue_etd, rechead_id, store_name, item, item_code, specification, unit, unit_price, item_image FROM(
            ...
            )D ON A.inventory_id = D.inventory_id LEFT JOIN(SELECT inventory_id, SUM(quantity)issue_qty, issue_etd from recdetails WHERE accept = 1 GROUP BY inventory_id, issue_etd
