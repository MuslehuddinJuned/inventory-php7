...
class SalaryController extends Controller
{
    ...
    public function index()
    {
        $Salary = DB::SELECT("SELECT B.id, A.id employee_id, A.employee_id official_id, first_name, designation, department, section, employee_image, 
            0 medic_alw_percent, 0 house_rent_percent, 0 ta_percent, 0 da_percent, 0 providant_fund_percent, 0 tax_percent,
            ...
            )A LEFT JOIN (SELECT id, basic_pay, medic_alw, house_rent, ta, da, providant_fund, tax, other_field, other_pay, total_salary, bank_name, acc_no, employee_id FROM salaries
