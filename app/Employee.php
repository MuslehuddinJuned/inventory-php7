...
class Employee extends Model
{
    protected $fillable = ['employee_id', 'first_name', 'last_name', 'address', 'mobile_no', 'email', 'blood_group', 'gender', 
        ...
        'father_name', 'district', 'sub_district', 'zip_code', 'area', 'present_district', 'present_sub_district', 'present_zip_code', 'present_area', 'qualification', 'epf_entitled_in', 'team_member_of', 'transferred', 
